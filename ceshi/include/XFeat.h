...
namespace ORB_SLAM3
{
    ...
    struct MBABlockImpl : torch::nn::Module
    {
        ...
        MBABlockImpl( int reduction=16);
        torch::Tensor forward(torch::Tensor x);
    };

    TORCH_MODULE(MBABlock);
    ...
    struct XFeatModel : torch::nn::Module
    {
        ...
        */
        ...
        torch::nn::Sequential block6{nullptr},
                              block7{nullptr},
                              block8{nullptr},
                              block9{nullptr},
                              block10{nullptr},
                              block11{nullptr};
        MBABlock mba_block{nullptr};
        ...
        XFeatModel();
        torch::Tensor unfold2d(torch::Tensor x, int ws=8);
