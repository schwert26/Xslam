...
void Frame::ExtractXF(int flag, const cv::Mat &im, const int x0, const int x1)
{
    ...
    if(flag==0)
    {
        ...
        std::cout << "Number of keypoints: " << mvKeys.size() << std::endl;
            if (!mvKeys.empty()) {
                float minX = mvKeys[0].pt.x, maxX = mvKeys[0].pt.x;
                float minY = mvKeys[0].pt.y, maxY = mvKeys[0].pt.y;
                ...
                std::cout << "Keypoint size: " << mvKeys[0].size << std::endl;
                std::cout << "X range: [" << minX << ", " << maxX << "]" << std::endl;
                std::cout << "Y range: [" << minY << ", " << maxY << "]" << std::endl;
            }
            std::cout << "Number of descriptors: " << mDescriptors.rows << std::endl;
            std::cout << "Descriptor dimension: " << mDescriptors.cols << std::endl;
    }
    else
...
void Frame::ComputeBoW()
{
    if(mBowVec.empty())
    {
        ...
        std::cout  << " shape: " << vCurrentDesc[1].rows << " x " << vCurrentDesc[1].cols  << ", type: " << vCurrentDesc[1].type() << std::endl;
